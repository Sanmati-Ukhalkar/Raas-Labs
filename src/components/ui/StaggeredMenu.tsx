...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    // Prelayers are hidden in CSS, skipping animation for performance
  ...
  React.useEffect(() => {
    if (open) {
      ...
      document.body.style.touchAction = 'none'; // Lock touch scroll
    } else {
  ...
  // Render via Portal to ensure z-index dominance over Hero/Header
    ...
    >
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel fixed inset-0 w-full h-full bg-transparent flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 pointer-events-auto"
          aria-hidden={!open}
        >
          {/* Glass Background */}
          <GradualBlur
            ...
            zIndex={-1}
            opacity={1}
            key={isMobile ? 'mobile' : 'desktop'} // Remount on change
          />
          {/* Overlay to ensure text contrast if needed */}
          <div className="absolute inset-0 bg-black/40 -z-[5]" />

          <div className="sm-panel-inner flex-1 flex flex-col gap-5 relative z-10 w-full max-w-[600px] ml-auto">
            <div className="flex flex-col h-full items-start lg:items-end lg:pr-20">
              <ul
              ...
              {displaySocials && socialItems && socialItems.length > 0 && (
                <div className="sm-socials mt-auto pt-8 flex flex-col gap-3 lg:items-end" aria-label="Social links">
                  <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#ff0000)]">Socials</h3>
                  <ul
                    className="sm-socials-list list-none m-0 p-0 flex flex-row items-center gap-4 flex-wrap lg:justify-end"
                    role="list"
                  >
                    {socialItems.map((s, i) => (
      ...
      <style>{`
.sm-scope .staggered-menu-wrapper { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 9999; pointer-events: none; }
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 1.5rem 1.5rem; background: transparent; pointer-events: none; z-index: 20; }
...
/* Full Screen Panel with Blur */
.sm-scope .staggered-menu-panel { position: absolute; top: 0; left: 0; width: 100vw; height: 100vh; background: transparent; display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10;  }
.sm-scope .sm-prelayers { display: none; } /* Hide prelayers as requested */
.sm-scope .sm-panel-inner { flex: 1; display: flex; flex-direction: column; gap: 1.25rem; }
.sm-scope .sm-socials { margin-top: auto; padding-top: 2rem; display: flex; flex-direction: column; gap: 0.75rem; }
.sm-scope .sm-socials-title { margin: 0; font-size: 1rem; font-weight: 500; color: var(--sm-accent, #B19EEF); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #B19EEF); outline-offset: 3px; }
.sm-scope .sm-socials-link { font-size: 1.2rem; font-weight: 500; color: #ffffff; text-decoration: none; position: relative; padding: 2px 0; display: inline-block; transition: color 0.3s ease, opacity 0.3s ease; }
...
@media (max-width: 768px) {
  ...
  .sm-scope .sm-socials { padding-bottom: 4rem; } /* High bottom padding for scroll safety */
}
      `}</style>
    </div>,
    document.body
