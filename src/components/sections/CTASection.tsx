        ...
        <FadeIn>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button variant="hero" size="xl" className="w-full sm:w-auto h-16 px-10" asChild>
              ...
              <Button variant="heroOutline" size="xl" className="w-full sm:w-auto h-16 px-10" asChild>
