      ...
      <div className="container mx-auto px-6 lg:px-16 xl:px-20 relative">
        <FadeIn>
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-7 tracking-[-0.02em]">
              Let's Explore If We're a Fit
            </h2>
            <p className="text-lg text-muted-foreground mb-12 max-w-lg mx-auto leading-relaxed font-light">
              We work with a select number of creators and brands to build 
              influence that lasts. Reach out to start the conversation.
            </p>
